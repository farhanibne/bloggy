...
export default function blogpage({blog,user,allComments}) {
    ...
    return (
        <div className="container center">
            ...
            <>
            <button className="btn #fb8c00 blue darken-1" onClick={()=>makeCommet()}>Make comment</button>
            <Link href="/">
            <button className="btn #fb8c00 green" style={{marginLeft:'15px'}}  >Back To Home</button>
            </Link>
            </>
            </>
            
            : <div style={{display:'flex',justifyContent:'center'}}><h6>please login to make comments</h6>
            <Link href="/">
            <button className="btn #fb8c00 green" style={{marginLeft:'15px'}} >Back To Home</button>
            </Link> </div>
            }
